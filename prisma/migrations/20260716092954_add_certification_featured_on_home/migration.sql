...
INSERT INTO "new_Certification" ("createdAt", "credentialUrl", "id", "imageUrl", "issueDate", "issuer", "profileId", "tier", "title", "updatedAt") SELECT "createdAt", "credentialUrl", "id", "imageUrl", "issueDate", "issuer", "profileId", "tier", "title", "updatedAt" FROM "Certification";
